...
import { expenseTransaction, user } from '../../../tests/fixtures'
import { UserNotFoundError } from '../../../errors'
import { GetTopFiveExpensesUseCase } from './get-top-five-expenses'
...
describe('GetTransactionUseCase', () => {
  ...
  let sut: GetTopFiveExpensesUseCase
  ...
  const setupUseCases = () => {
    ...
    sut = new GetTopFiveExpensesUseCase(transactionRepository, usersRepository)
  }
  ...
  it('should call GetFiveTopExpense with correct values', async () => {
    // arrange
    const userId = '1'
    const categoryId = '2'
    const transaction = await createAndRegisterUserTransaction(
    ...
    const executeSpy = vi.spyOn(transactionRepository, 'findTopFiveExpenses')
  ...
  it('should throw if GetFiveTopExpense throws', async () => {
    // arrange
    const userId = '1'
    const categoryId = '2'
    const transaction = await createAndRegisterUserTransaction(
